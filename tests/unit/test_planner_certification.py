...
def test_native_and_normalized_qualification_evidence_is_ambiguous(conn):
...
def test_normalized_qualification_evidence_binds_normalizer_identity(conn):
    normalized_profile = RuntimeContextProfile(
        model_tag="devstral:24b",
        effective_context_tokens=8192,
        output_token_budget=1024,
...
def test_normalized_transport_with_native_only_profile_is_refused(conn):
