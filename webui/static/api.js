...
export function createAPI(fetcher = globalThis.fetch.bind(globalThis)) {
  ...
  return {
    ...
    archiveRuntimeWorker: (workerId) => request(`/runtime/workers/${id(workerId)}/archive`, {}),
    reactivateRuntimeWorker: (workerId) => request(`/runtime/workers/${id(workerId)}/reactivate`, {}),
    ...
    certificationPlannerPreflight: (workerId) => request(`/certification/workers/${id(workerId)}/planner/preflight`, {}),
    startPlannerCertification: (workerId) => request(`/certification/workers/${id(workerId)}/planner/runs`, {}),
